...
local function checkItemDisplay (itemId, itemLink)
  ...
  elseif (saved.farmerOptions.focus == true) then
    return false;
  end
  ...
  if (saved.farmerOptions.reagents == true and
      (isCraftingReagent == true or
       itemClassID == LE_ITEM_CLASS_TRADEGOODS)) then
    return true;
  end

  if (saved.farmerOptions.questItems == true and
      (itemClassID == LE_ITEM_CLASS_QUESTITEM or
       itemClassID == LE_ITEM_CLASS_KEY)) then
    return true;
  end

  if (saved.farmerOptions.recipes == true and
      itemClassID == LE_ITEM_CLASS_RECIPE) then
    return true;
  end

  if (saved.farmerOptions.rarity == true and
      itemRarity >= saved.farmerOptions.minimumRarity) then
    return true;
  end
